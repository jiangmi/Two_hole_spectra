'''
Cu site (only one) and O square lattice surrounding it. Difference from CuO2 lattice,
there is no unit cell representation anymore. The whole lattice is a unit cell!
'''
